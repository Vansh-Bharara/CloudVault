...
function FileList() {
    ...
    async function fetchFiles() {
        try {
            setLoading(true);
            const endpoint = query ? "/api/files/search?q=".concat(query) : "/api/files/list";
    ...
    const onQueryChange = (e)=>{
        var _e_target;
        setQuery(e === null || e === void 0 ? void 0 : (_e_target = e.target) === null || _e_target === void 0 ? void 0 : _e_target.value);
    };
    ...
    async function handleDownload(id) {
        const res = await fetch("/api/files/download/".concat(id));
        if (!res.ok) {
    ...
    async function handleDelete(id) {
        ...
        const res = await fetch("/api/files/delete/".concat(id), {
            method: "DELETE"
        });
        if (res.ok) {
            setFiles((f)=>f.filter((x)=>x.id !== id));
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])("File deleted successfully !");
        } else {
    ...
    if (!files.length) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
...
_s(FileList, "J8L2QIatHbP8kkEO0mC/VtCYtu0=");
_c = FileList;
var _c;
