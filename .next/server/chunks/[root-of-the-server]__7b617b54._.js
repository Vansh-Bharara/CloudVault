...
"[project]/.next-internal/server/app/api/files/[fileId]/version/[versionNumber]/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
;
const FileSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["Schema"]({
    ownerId: {
...
"[project]/lib/models/FileVersion.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs)");
;
const FileVersionSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["Schema"]({
    fileId: {
        type: __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["Schema"].Types.ObjectId,
        ref: "File",
        required: true,
...
"[project]/app/api/files/[fileId]/version/[versionNumber]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function DELETE(req, { params }) {
    ...
    if (version.s3Key !== "PENDING") {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$s3$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteS3Object"])(version.s3Key);
    }
    //delete metadata
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$FileVersion$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].deleteOne({
        _id: version._id
    });
    //remaining versions check
    const remainingVersions = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$FileVersion$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
        fileId: fileIdObject
    }).sort({
        versionNumber: -1
    ...
    if (remainingVersions.length === 0) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$File$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].deleteOne({
            _id: fileIdObject
        });
    } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7b617b54._.js.map