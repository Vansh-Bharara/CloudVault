...
"[project]/.next-internal/server/app/api/files/upload/init/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/app/api/files/upload/init/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    const existingFile = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$File$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
        ownerId: userId,
    ...
    if (!existingFile) {
        versionNumber = 1;
        const newFile = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$File$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            ownerId: userId,
            originalName: originalFileName,
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$FileVersion$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
        fileId,
        versionNumber,
        s3Key: "PENDING",
        size,
    ...
    const uploadUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$s3$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPresignedUploadUrl"])(s3Key, mimeType);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        fileId,
        versionNumber,
        s3Key,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c2182869._.js.map