...
"[project]/.next-internal/server/app/api/files/delete/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/app/api/files/delete/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function DELETE(req, { params }) {
    ...
    const file = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$File$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id);
    ...
    if (file.userEmail !== session.user?.email) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Forbidden"
    }, {
        status: 403
    });
    // delete object from S3 and then metadata
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$s3$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteS3Object"])(file.s3Key);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8f6e36bc._.js.map